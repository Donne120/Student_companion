...
import { Loader, Eye, EyeOff, MessageCircle, Send, ChevronRight } from "lucide-react";
import { Separator } from "@/components/ui/separator";

// Demo chat conversations that showcase the platform's capabilities
// Using HTML-like formatting that will be rendered properly
const demoChats = [
  {
    id: 1,
    question: "What's my GPA requirement to keep my scholarship?",
  ...
  {
    id: 4,
    question: "I need help with my course registration",
...
const demoResponses: { [key: number]: React.ReactNode } = {
  0: (
    <div className="space-y-3">
      <p>To maintain your scholarship at ALU:</p>
      <p>📊 <span className="text-brand-gold font-semibold">Minimum GPA Required:</span> 3.0 on a 4.0 scale</p>
      <div>
        <p className="text-brand-gold font-semibold mb-1">Other Requirements:</p>
        <p>✅ Complete community service hours</p>
        <p>✅ Participate in leadership activities</p>
        <p>✅ Submit progress reports each semester</p>
        <p>✅ Maintain good conduct</p>
      </div>
      <p className="text-yellow-400">⚠️ Your scholarship is reviewed annually. Need help improving your grades? I can connect you with tutoring services!</p>
    </div>
  ),
  1: (
    <div className="space-y-3">
      <p>Let me check your upcoming deadlines! 📅</p>
      <div>
        <p className="text-brand-gold font-semibold mb-1">This Week:</p>
        <p>• Data Structures Project - Due Friday, 11:59 PM</p>
        <p>• Leadership Essay - Due Saturday, 5:00 PM</p>
        <p>• Economics Quiz - Opens Monday</p>
      </div>
      <div>
        <p className="text-brand-gold font-semibold mb-1">Pro Tips:</p>
        <p>💡 Submit early to avoid last-minute issues</p>
        <p>📚 Visit the Writing Center for essay help</p>
      </div>
      <p>Want me to set up reminders for these?</p>
    </div>
  ),
  2: (
    <div className="space-y-3">
      <p>Here's how to access ALU Library resources! 📚</p>
      <div>
        <p className="text-brand-gold font-semibold mb-1">Online Access:</p>
        <p>🔗 library.alueducation.com</p>
        <p>• Use your ALU student credentials</p>
        <p>• Access 24/7 from anywhere</p>
      </div>
      <div>
        <p className="text-brand-gold font-semibold mb-1">Available Resources:</p>
        <p>• EBSCOHost databases</p>
        <p>• BUKU E-Textbooks</p>
        <p>• LIBRARIKA Catalog</p>
        <p>• Research journals</p>
      </div>
      <div>
        <p className="text-brand-gold font-semibold mb-1">Physical Library:</p>
        <p>📍 Open 7am-11pm (Mon-Fri)</p>
        <p>📍 9am-9pm (Weekends)</p>
      </div>
      <p>Need help finding a specific resource?</p>
    </div>
  ),
  3: (
    <div className="space-y-3">
      <p>I'll help you with course registration! 🎓</p>
      <div>
        <p className="text-brand-gold font-semibold mb-1">Steps to Register:</p>
        <p>1️⃣ Log into the Student Portal</p>
        <p>2️⃣ Go to 'Course Registration'</p>
        <p>3️⃣ Select your semester</p>
        <p>4️⃣ Choose courses (check prerequisites!)</p>
        <p>5️⃣ Submit and confirm</p>
      </div>
      <div>
        <p className="text-brand-gold font-semibold mb-1">Important Dates:</p>
        <p>📅 Registration opens: Next Monday</p>
        <p>📅 Add/Drop deadline: 2 weeks after</p>
      </div>
      <p>📧 <span className="text-brand-gold font-semibold">Need Advisor Help?</span> academics@alueducation.com</p>
    </div>
  ),
  4: (
    <div className="space-y-3">
      <p>Your wellbeing matters! Here are support options: 💚</p>
      <div>
        <p className="text-brand-gold font-semibold mb-1">On-Campus Counseling:</p>
        <p>📍 Student Wellness Center</p>
        <p>📅 Mon-Fri, 9am-5pm</p>
        <p>📧 counseling@alueducation.com</p>
      </div>
      <div>
        <p className="text-brand-gold font-semibold mb-1">Services Available:</p>
        <p>• Personal counseling (confidential)</p>
        <p>• Academic stress management</p>
        <p>• Peer support groups</p>
        <p>• Crisis intervention</p>
      </div>
      <p className="text-green-400">📞 24/7 Emergency hotline available</p>
      <p>Would you like me to help you schedule an appointment? Everything is completely confidential. 🤝</p>
    </div>
  )
};
...
export default function Login() {
  ...
  return (
    <div className="min-h-screen flex bg-gradient-to-br from-[#1e3a8a] via-[#2563eb] to-[#1e40af] relative overflow-hidden">
      ...
      {/* Left side - Interactive Demo Chat */}
      <div className="hidden lg:flex lg:w-1/2 flex-col justify-center items-center p-6 relative z-10">
        <div className="max-w-xl w-full space-y-4">
          ...
          <div className="bg-[#0A1628]/95 backdrop-blur-xl rounded-2xl border-2 border-brand-gold/40 shadow-2xl overflow-hidden transform hover:scale-[1.01] transition-transform duration-300">
              ...
              {activeDemo === null && (
                <div className="flex flex-col items-center justify-center h-full text-center space-y-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400 text-sm">See what's waiting for you!</p>
                  </div>
                </div>
              )}
            </div>
            ...
            <div className="px-5 py-4 border-t border-white/10 bg-gradient-to-r from-white/5 to-white/10">
              <div className="flex items-center gap-3 bg-white/10 rounded-full px-5 py-3 border border-white/20">
                <input
                  type="text"
                  placeholder="Sign in to continue chatting..."
          ...
          <div className="space-y-3">
            <p className="text-white/80 text-sm text-center font-medium">👆 Click to preview different questions:</p>
          ...
          <div className="text-center pt-3 space-y-2">
            <p className="text-white text-base">
              <span className="text-brand-gold font-bold">Your personalized assistant</span> is waiting
            </p>
            <div className="flex items-center justify-center gap-2 text-gray-300 text-sm">
              <ChevronRight className="w-5 h-5 text-brand-gold animate-bounce" />
              <span>Sign in to continue your conversation</span>
              <ChevronRight className="w-5 h-5 text-brand-gold animate-bounce" />
            </div>
          </div>
        </div>
